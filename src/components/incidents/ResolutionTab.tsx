...
import StatsLine from '@/components/alertsId/StatsLine';
import StatsColumn from '@/components/alertsId/StatsColumn';
import StatsArea from '@/components/alertsId/StatsArea';
import LineChartOtif from '@/components/alertsId/LineChartOtif';
