          ...
          <div className="my-2 flex items-baseline gap-2">
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-base font-medium text-gray-900">In Full Rate <span className="text-sm text-gray-500">(hours)</span></h2>
            ...
            <div className="ml-auto flex items-center gap-x-2 overflow-x-hidden ">
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectItem value="supplier">By Product Category</SelectItem>
                  <SelectItem value="productType"> By Supplier</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
