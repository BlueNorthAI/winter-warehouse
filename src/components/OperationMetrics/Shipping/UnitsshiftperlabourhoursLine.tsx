...
export default function UnitsshiftperlabourhoursLine() {
          ...
          <div className="my-2 flex items-baseline gap-2">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-base font-medium text-gray-900"> Units Shift per Labour Hours<span className="text-sm text-gray-500">(per Truck)</span></h2>
            ...
            <div className="ml-auto flex items-center gap-x-2 overflow-x-hidden ">
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectItem value="documentType">By Shift</SelectItem>
                  <SelectItem value="documentType"> By Time</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
