...
export default function DocktodepaturetimeLine() {
          ...
          <div className="my-2 flex items-baseline gap-2">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-base font-medium text-gray-900"> Dock to Departure Time<span className="text-sm text-gray-500">(per Truck)</span></h2>
            ...
            <div className="ml-auto flex items-center gap-x-2 overflow-x-hidden ">
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectItem value="documentType">By Carrier</SelectItem>
                  <SelectItem value="documentType"> Statistical Process Control</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
