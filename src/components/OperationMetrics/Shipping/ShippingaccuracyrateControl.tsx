...
export default function ShippingaccuracyrateControl() {
    ...
    <Card >
      ...
      <CardHeader className="px-4 py-2">
        <div className="my-2 flex items-baseline gap-2">
          <div>
            <h2 className="text-base font-medium text-gray-900">Shipping Accuracy Rate <span className="text-sm text-gray-500">(hours)</span></h2>
          ...
          <div className="ml-auto flex items-center gap-x-2 overflow-x-hidden ">
            ...
            <Select>
              <SelectTrigger className="w-30 h-7">
                <SelectValue placeholder="By Error Type" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="costComponent">By Error Type
                </SelectItem>
                <SelectItem value="costComponent">Statistical Process Control</SelectItem>
