...
export default function DockdoorutilizationLine() {
          ...
          <div className="my-2 flex items-baseline gap-2">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-base font-medium text-gray-900"> Dock Door Utilization<span className="text-sm text-gray-500">(per Truck)</span></h2>
                <Badge variant="outline" className="bg-yellow-50 text-yellow-700 border-yellow-300 h-7 flex items-center">
                  Efficiency
                </Badge>
              </div>
              <h1 className="text-3xl font-bold text-black">10000</h1>
            </div>
            <div className="ml-auto flex items-center gap-x-2 overflow-x-hidden ">
             
              <Select>
                <SelectTrigger className="w-30 h-7">
                  <SelectValue placeholder="By Time Of Day" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="documentType">By Time Of Day</SelectItem>
                  <SelectItem value="documentType"> By Door Location</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
