...
export default function PackingqualityControl() {
    ...
    <Card >
      ...
      <CardHeader className="px-4 py-2">
        <div className="my-2 flex items-baseline gap-2">
          <div>
            <h2 className="text-base font-medium text-gray-900">Packing Quality Control <span className="text-sm text-gray-500">(hours)</span></h2>
          ...
          <div className="ml-auto flex items-center gap-x-2 overflow-x-hidden ">
            ...
            <Select>
              <SelectTrigger className="w-30 h-7">
                <SelectValue placeholder="By Issue Type" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="costComponent">By Issue Type
                </SelectItem>
