...
export default function OrderprocessedperdockdooeBar() {
    ...
    <Card >
      ...
      <CardHeader className="px-4 py-2">
        <div className="my-2 flex items-baseline gap-2">
          <div>
            <h2 className="text-base font-medium text-gray-900">Order Processed per Dock Door <span className="text-sm text-gray-500">(units)</span></h2>
            <h1 className="text-3xl font-bold text-black">90%</h1>
          </div>
          <div className="ml-auto flex items-center gap-x-2 overflow-x-hidden ">
            <Badge variant="outline" className="bg-yellow-50 text-purple-700 border-purple-300 h-7 flex items-center">
              Time
            </Badge>
            <Select>
              <SelectTrigger className="w-30 h-7">
                <SelectValue placeholder="By Door Location" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="shift">By Door Location</SelectItem>
                <SelectItem value="department">Time Series</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </div>
