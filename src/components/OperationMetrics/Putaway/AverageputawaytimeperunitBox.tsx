...
export default function AverageputawaytimeperunitBox() {
    ...
    <Card >
      ...
      <CardHeader className="px-4 py-2">
        <div className="my-2 flex items-baseline gap-2">
          <div>
            <h2 className="text-base font-medium text-gray-900">Average Putaway Time per Unit <span className="text-sm text-gray-500">(hours)</span></h2>
