    ...
    <Card >
      ...
      <CardHeader className="px-4 py-2">
        <div className="my-2 flex items-baseline gap-2">
          <div>
            <h2 className="text-base font-medium text-gray-900">Units Putaway per Labour <span className="text-sm text-gray-500">(units)</span></h2>
          ...
          <div className="ml-auto flex items-center gap-x-2 overflow-x-hidden ">
            ...
            <Select>
              ...
              <SelectContent>
                <SelectItem value="shift">By Operator</SelectItem>
                <SelectItem value="department">By Shift</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </div>
