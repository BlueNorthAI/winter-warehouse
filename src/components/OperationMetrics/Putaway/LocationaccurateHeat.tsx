...
export default function LocationaccurateHeat() {
        ...
        <div className="my-2 flex items-baseline gap-2">
          ...
          <div className="ml-auto flex items-center gap-x-2 overflow-x-hidden ">
            <Select>
              ...
              <SelectContent>
                <SelectItem value="supplier">By Zone  </SelectItem>
                <SelectItem value="productType">Statistical Process Control</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </div>
