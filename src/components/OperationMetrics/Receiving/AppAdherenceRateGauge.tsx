...
export default function AppAdherenceRateGauge() {
    ...
    <Card >
      ...
      <CardHeader className="px-4 py-2">
        <div className="my-2 flex items-baseline gap-2">
          <div>
            <h2 className="text-base font-medium text-gray-900">Appointment Adherence Rate<span className="text-sm text-gray-500">(hours)</span></h2>
            <h1 className="text-3xl font-bold text-black">90%</h1>
          </div>

          <div className="ml-auto flex items-center gap-x-2 overflow-x-hidden ">
            <Badge variant="outline" className="bg-pink-50 text-pink-700 border-pink-300 h-7 flex items-center">
              Quality
            </Badge>
            <Select>
