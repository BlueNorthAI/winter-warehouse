...
export default function OtifLine() {
  return (
    <>
          ...
          <div className="my-2 flex items-baseline gap-2">
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-base font-medium text-gray-900">OTIF(On Time In Full) <span className="text-sm text-gray-500">(hours)</span></h2>
                <Badge variant="outline" className="bg-yellow-50 text-yellow-700 border-yellow-300 h-7 flex items-center">Order Fullfillment</Badge>
              </div>
