...
export default function NumTrucksLine() {
                    ...
                    <div className="my-2 flex items-baseline gap-2">
                        <div>
                            <div className="flex items-center gap-2">
                                <h2 className="text-base font-medium text-gray-900">Number of Trucks/Containers Processed<span className="text-sm text-gray-500">(per Truck)</span></h2>
