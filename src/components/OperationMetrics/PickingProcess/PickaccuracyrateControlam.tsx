  ...
  return (
    <Card >
       <div className="relative rounded-lg">
          <span className={`absolute inset-x-0 top-0 h-1 rounded-lg ${
      ...
      <CardHeader className="px-4 py-2">
        <div className="my-2 flex items-baseline gap-2">
          <div>
            <h2 className="text-base font-medium text-gray-900">Pick Accuracy Rate <span className="text-sm text-gray-500">(hours)</span></h2>
          ...
          <div className="ml-auto flex items-center gap-x-2 overflow-x-hidden ">
            ...
            <Select>
              <SelectTrigger className="w-30 h-7">
                <SelectValue placeholder="Statistical Process Control" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="costComponent">Statistical Process Control

                </SelectItem>
                <SelectItem value="costComponent"> Overall KPI</SelectItem>
