  ...
  return (
    <Card className="w-full border-0 shadow-none">
      <CardContent className="p-0">
        {/* Filters */}
        {/* <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4 bg-gray-50 border-b">
          <div>
            <label className="text-sm font-medium">Lane (Internal/External)</label>
          ...
          <div>
            <label className="text-sm font-medium">Delivery Location State/Province</label>
            <Select defaultValue="all">
              <SelectTrigger className="mt-1">
                <SelectValue placeholder="(ALL)" />
              </SelectTrigger>
          ...
          <div>
            <label className="text-sm font-medium">Delivery Location City</label>
            <Select defaultValue="all">
              <SelectTrigger className="mt-1">
                <SelectValue placeholder="(ALL)" />
              </SelectTrigger>
          ...
          <div>
            <label className="text-sm font-medium">Pickup Location State/Province</label>
            <Select defaultValue="all">
              <SelectTrigger className="mt-1">
                <SelectValue placeholder="(ALL)" />
              </SelectTrigger>
          ...
          <div>
            <label className="text-sm font-medium">Pickup Location City</label>
            <Select defaultValue="all">
              <SelectTrigger className="mt-1">
                <SelectValue placeholder="(ALL)" />
              </SelectTrigger>
